package com.alpha.whizwish.CustomBehaviors;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public AvatarImageBehavior(
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.alpha.whizwish.R.styleable.AvatarImageBehavior);
            finalXPosition = a.getDimension(com.alpha.whizwish.R.styleable.AvatarImageBehavior_finalXPosition, 0);
            finalYPosition = a.getDimension(com.alpha.whizwish.R.styleable.AvatarImageBehavior_finalYPosition, 0);
            finalHeight = a.getDimension(com.alpha.whizwish.R.styleable.AvatarImageBehavior_finalHeight, 0);
            finalToolbarHeight = a.getDimension(com.alpha.whizwish.R.styleable.AvatarImageBehavior_finalToolbarHeight, 0);
            a.recycle();
        }
    }
