...
public class ShareGift extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_share_gift, container, false);
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            ...
            if (data != null) {
               image_uri = data.getData();
                ...
                caption_image.setImageURI(data.getData());
               // Picasso.with(getContext()).load(data.getData()).resize(40, 40).into(caption_image);
            }
        }
    }
